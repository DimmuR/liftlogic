...
const blocksByWeight: Record<number, WeightBlockData> = {
    2500: {weight: 25, width: 10, height: 70, css: {fill: 'rgb(255,0,0)', stroke: 'rgb(0,0,0)'}},
    2000: {weight: 20, width: 10, height: 70, css: {fill: 'rgb(152,152,236)', stroke: 'rgb(0,0,0)'}},
    1500: {weight: 15, width: 10, height: 60, css: {fill: 'rgb(222,222,222)', stroke: 'rgb(0,0,0)'}},
    1000: {weight: 10, width: 10, height: 50, css: {fill: 'rgb(222,222,222)', stroke: 'rgb(0,0,0)'}},
    500:  {weight: 5, width: 10, height: 40, css: {fill: 'rgb(222,222,222)', stroke: 'rgb(0,0,0)'}},
    250:  {weight: 2.5, width: 10, height: 30, css: {fill: 'rgb(0,0,0)', stroke: 'rgb(0,0,0)'}},
    125:  {weight: 1.25, width: 10, height: 20, css: {fill: 'rgb(222,222,222)', stroke: 'rgb(0,0,0)'}},
}
